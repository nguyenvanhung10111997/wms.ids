...
namespace wms.infrastructure
{
    public class ContainerManager
    {
        ...
        public virtual object ResolveUnregistered(Type type, ILifetimeScope scope = null)
        {
            ...
            foreach (var constructor in constructors)
            {
                try
                {
                    ...
                    foreach (var parameter in parameters)
                    {
                        ...
                        if (service == null) throw new Exception("Core.Infrastructure: Unknown dependency");
            ...
            throw new Exception("Core.Infrastructure: No constructor  was found that had all the dependencies satisfied.");
        }
        ...
        public virtual ILifetimeScope Scope()
        {
            ...
            catch (Exception)
            {
                ...
                //for wms, requested in or after "Application_EndRequest" handler
